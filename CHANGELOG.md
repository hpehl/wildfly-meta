...
- Add `supports_stability()` method to `WildFlyImage` to check whether an image supports a given stability level
...
[Unreleased]: https://github.com/hpehl/wildfly-meta/compare/v0.7.1...HEAD
[0.7.1]: https://github.com/hpehl/wildfly-meta/compare/v0.7.0...v0.7.1
[0.7.0]: https://github.com/hpehl/wildfly-meta/compare/v0.6.1...v0.7.0
